...
import e.lengku8e.myapplication.R;
import karics.library.zxing.camera.CameraManager;
import karics.library.zxing.decode.DecodeThread;
import karics.library.zxing.view.ViewfinderResultPointCallback;
